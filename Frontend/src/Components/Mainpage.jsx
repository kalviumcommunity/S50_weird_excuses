    ...
    <div className="flex justify-center">
            ...
            <nav className="flex flex-col justify-start">
              <a
                ...
                className={`text-gray-800 mb-4 hover:bg-gray-400 transition-colors duration-300 flex items-center p-2 rounded-2xl ${
                  !showNotifications && !showBookmarks ? "bg-gray-400" : ""
                }`}
                onClick={() => {
      ...
      <div className="w-3/4 bg-gray-100 h-screen p-8 overflow-x-auto">
        {showNotifications ? (
          ...
          <Bookmarks onClose={() => setShowBookmarks(false)} />
        ) : (
          <>
            ...
            >
              ...
              {users
                .filter(
                  (user, index, self) =>
                    self.findIndex((u) => u.User_Name === user.User_Name) ===
                    index
                )
                .map((user) => (
            ...
            {filteredExcuses.length === 0 ? (
              <p className="text-center">No posts from this user.</p>
            ) : (
